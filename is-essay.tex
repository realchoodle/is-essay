...
{\centering Art, Cognitive Science, and Entangled Domains\par}
...
Dance. In \textit{The Entanglement}, Noë primarily refers to distance as a means
of going ``second-order''; for instance, he notes that a detached attitude is
required for philosophical work \autocite[188--189]{noeEntanglement2023}.
However, here I borrow my concept of respect from Byung-Chul Han. For Han,
``Respect presupposes a distanced look''; to respect something is, in part, to
distance yourself from it. Han contrasts respect with ``spectacle,'' a kind of
``voyeuristic gazing'' without deference \autocite[1]{hanSwarm2017}. When one
...
One could argue that the entanglement of dance and Dance is best understood in
terms of a spectrum. It could be, for instance, that Dance is dance made
technical. Consequently, the entanglement is unnecessary to understand how these
concepts relate to each other; instead, we only need a spectrum of artfulness or
technicality. That dance and Dance exist along the same spectrum may capture
some aspects of their relationship. However the entanglement is partly concerned
with our perception of concepts, not just their ontology; it starts, after all,
from phenomenology \autocite[21--22]{noeEntanglement2023}. While we view tools
as extending our habitual selves (say, by letting us communicate more
efficiently), it seems that we do not view art in the same way. Art seems to
...
\autocite[152]{arendtFuture1968}. Hence, here we see a lower-order (order $n$)
style of engagement with the concept of freedom, in that freedom and dance both
share some ostensibly unfettered spontaneity.

If, for us, freedom is political and spontaneous, then where does the problem of
free will come from? Arendt argues that it begins with the transference of the
public concept of freedom to an ``inward domain.'' Once freedom became a topic
of philosophical reflection by way of an inward domain, it lost its public
meaning \autocite[146]{arendtFuture1968}. There is an analogy here between
lower-order activities such as dance and the public sphere; just as dance helps
substantiate Dance, the public sphere helps substantiate philosophy and science
by providing, and ostensibly originating, certain concepts (freedom, in this
case). Here, it is worth noting the epistemic aspects of this emerging
...
public sphere; they are to the public sphere as Dance is to dance. Together
they, among other truth oriented pursuits, form an exclusive realm. There may be
variations between how members of the exclusive domain understand truth, but
unlike the public sphere, they nonetheless foreground their conceptualization of
it. Moreover, these exclusive fields tend to occupy higher-order positions in
their entanglements. As members of the exclusive domain, however, they act as
lower-order concepts, entangled with the higher-order (that is, order $n+1$)
realm of the exclusive.

Beyond being truth-oriented, exclusivity is often institutional. Even art has
obviously institutional aspects, and these motivate, for instance, institutional
definitions of art \autocite[8]{winnerHow2019}. Institutional definitions of art
are particularly noteworthy here; because philosophers tend to be the ones
proposing them, they represent a fully exclusive understanding of art. Of
course, none of these disciplines are, in truth, wholly exclusive. Yet, that is
precisely the point; the public and exclusive spheres are entangled.
...
latter respects the former. As mentioned earlier, Byung-Chul Han understands
respect as involving a distanced look \autocite[1]{hanSwarm2017}. In these
terms, a lack of respect shows up as denying the public sphere's centrality.
This denial creates distance, but it also threatens to push out the public
sphere entirely, resulting in a kind of ignorance. Respect, furthermore, is
``tied to names,'' and these names are a condition of recognition
\autocite[2]{hanSwarm2017}. Thus, respect requires both distance and
recognition; objects of respect are set apart, but not ignored
\autocite[7]{hanSwarm2017}.  Arendt's analysis of the problem of free will
serves as an example of entanglement without respect. Free will, she argues, was
a concept belonging to politics and interpersonal affairs
...
particular). As a result, determinism, despite its force in philosophic or
...
23]{nanayMental2023}. This latter concern relates to Arendt's notion of an
...
Nanay's view relies on what Noë calls a ``trigger conception'' of art
...
In \textit{Attentional Engines}, William Seeley offers a cognitive theory of art
and aesthetic experience that also relies on the trigger conception. For Seeley,
artworks are ``attentional engines''; they direct our attention to features that
enable us to categorize them, thus allowing us to recover their ``artistically
salient content'' \autocite[50]{seeleyAttentional2020}. To his credit, Seeley
argues that the raw perceptual content of an art object is insufficient for
aesthetic experiences. In addition, one needs to know the work's historical and
cultural context, its maker's categorical intentions, and the relevant set of
artistic categories \autocite[113-114, 49--50, 31]{seeleyAttentional2020}.

Nevertheless, within the framework developed thus far, Seeley's theory presents
two key issues. First, the view of art as an ``engine'' devalues the agential
and conscious aspects of aesthetic experience. Moreover, as with Nanay's view,
it limits aesthetic experience to moments of direct engagement. Second, it
leaves little room for the non-exclusive aspects of art and artistic
experiences. For instance, Seeley limits the knowledge required to properly
experience an artwork to that of the exclusive domain. For example, Seeley
argues that artworks gain their meaning by being situated in an ``atmosphere of
theory'' \autocite[42]{arendtFuture1968}. Thus, while Seeley's view has the
advantage of recognizing the entanglements of art, science, and philosophy, it
ultimately limits the scope of artistic entanglements to the exclusive domain.

Under either of the views presented above, one has to ask: who cares about art?
Why was it worth studying in the first place in terms of its own category? Under
the trigger conception, art is the sufficient condition for some set of
interesting or moving experiences. Does it matter if we get those experiences
from art? In my view, this is one of the primary threats of the trigger
conception; when art becomes fully exclusive, it risks becoming instrumental.
Further, in light of these views, one should question who art is for, and who
can do it.

It seems to me that, on their own, no amount of fleeting ``aesthetic
experiences'' sufficiently explains the salience of art as whole. Instead, art
matters, and is worth investigating, because of its work within the public
sphere. Nevertheless, there are the fleeting embraces of artistic form that
supply the notion of an aesthetic experience with its kernel of truth. Eduard
Hanslick supposes something similar when he asserts that musical meaning and
musical form are identical \autocite[46--47]{hanslickEduard2018}. For Hanslick,
``Nothing could be more fallacious and more prevalent than the view that
differentiates between `beautiful music' with and without intellectual content''
\autocite[46--47]{hanslickEduard2018}. Hanslick's assertion here amounts to a
rejection of purely exclusive notions of music; music's meaning and beauty are
one. To understand musical meaning, Hanslick turns to metaphors that point to
other experiences; musical meaning is like an animated arabesque, or a
kaleidoscope \autocite[41--42]{hanslickEduard2018}.

Hanslick's notion of musical meaning, then, is almost entirely experiential and
humanistic, and thus in this respect, exclusively public. But again, art stays
with us after our direct experiences of it; it reworks us, and so it goes where
we go. Within the public sphere, art does more than just provide experiences. I
claim that it may become a kind of the aforementioned ``word and deed''
\autocite[148]{arendtFuture1968}. Not all works are communicative acts, but
undoubtedly, art can communicate. Moreover, in reorganizing us, art acts.
Further, while no artwork is completely novel in a broad sense, art can still
exemplify Arendt's concept of natality, or the ability to create new beginnings
\autocite[9]{arendtHuman2018}. It reveals this capacity through the conditions
of its making; what great works have been produced under the assumption that one
is an epigone?
%Finally, the discourse around art is elevated above the realm of necessity;
%making it a kind of political discourse.

% Quick NOTE: mattering is entangled; matters in the first place because of
% common stuff and scientists seeing it but then also art itself was exclusive
% so higher lower not first second.
Yet crucially, art is not just a public concept. Indeed, art became worthy of
study through its appearance in the public sphere. However, the entanglement of
the public and exclusive domains means that this separation is never clean. Art
is, in many of the ways outlined by Seeley and Nanay, exclusive as well. The
lower-order is never fully naïve; consequently, even the most immediate
experiences of beauty will have all sorts of institutional, biological, and
historical influences. It is likely that the exclusive sphere has already looped
down several times over, and so the cognitive scientist, philosopher, or artist
never encounters something completely foreign to them, even insofar as they are
members of the exclusive domain. Moreover, we do have brains, after all! If we
come into contact with art, we do so with, and through, our perceptual
mechanisms.

Hence, I am not suggesting that the proper way to deal with the entanglement of
the public and exclusive is to move to some form of ordinary language philosophy
or exclusively focus on phenomenology. In many ways, acknowledging this
entanglement means business as usual for the exclusive domain; it does not
require cognitive scientists to abandon their empirical methods or philosophers
to stop theorizing. What must change, however, is how we interpret work within
these fields; insofar as one is a member of the exclusive sphere, they ought to
respect the concepts of the political realm. As Han notes, respect presupposes a
distanced look \autocite[1]{hanSwarm2017}. Yet, a distanced look is a look
nonetheless; one must, as Nietzsche put it, have an eye towards life
\autocite[100--101]{nietzscheUnfashionable1995}. Furthermore, the entanglement
of the public and exclusive spheres means the cognitive scientist or philosopher
must ask themselves how their findings relate to the phenomena they started
with. Even if their research in the exclusive domain reveals that the public
sphere has misled itself of become disingenuous, they must keep shared human
experience close, rather than abandoning the political sphere.
